...
internal static class Log
{
    ...
    internal static void Exception(Exception exception,string message = "An exception has been caught.", string header = "NeoPixel", string panelTitle = "NeoPixel Exception")
    {
    ...
    internal static void Debug(string msg, bool canLog = true, string header = "ArtNeoPixel")
    {
        if(!canLog)
            return;
    ...
    /// <param name="header">The header to log.</param>
    internal static void Info(string msg, string header = "NeoPixel")
    {
    ...
    /// <param name="header">The header to log.</param>
    internal static void Warn(string msg, string header = "NeoPixel")
    {
    ...
    /// <param name="header">The header to log.</param>
    internal static void Error(string msg, string header = "NeoPixel")
    {
        AnsiConsole.Markup($"[dark red][[[/][dark red bold]Error[/][dark red]]] [[/][dark red bold]{header}[/][dark red]][/][dark red italic] {msg}[/]");
    }
}